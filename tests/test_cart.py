...
def create_test_user():
    ...
    phone = str(9000000000 + (uuid4().int % 100000000))
...
def test_order_items():
    ...
    assert items[0][4] == 1
    assert items[0][5] == 500.00
    assert items[0][6] == 500.00
...
def test_user_orders():
    ...
    assert orders[0][1] == "pending"
    assert orders[0][2] == 500.00
